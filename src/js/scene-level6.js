/**
 * Scene for Level 6: random maze minigame. Same look as level 2 (both brick textures loaded).
 */
...
export function injectSceneContentLevel6(scene) {
  ...
  const { container, startPosition } = createLevel6(scene, usePhysics);
